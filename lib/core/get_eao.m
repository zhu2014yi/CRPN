...
addpath('/ssd/vot-toolkit/'); toolkit_path; % Make sure that VOT toolkit is in the path
cd('/ssd/vot-workspace');
pwd = ['/ssd/', 'vot-workspace',year]  % year is a str (can not be a number)
