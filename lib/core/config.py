...
# augmentation
config.SIAMRPN.DATASET.NEG=0.2
config.SIAMRPN.DATASET.TEMPLATE_SHIFT = 4
config.SIAMRPN.DATASET.SEARCH_SHIFT = 12

config.SIAMRPN.DATASET.TEMPLATE_SCALE = 0.05
config.SIAMRPN.DATASET.SEARCH_SCALE = 0.18
