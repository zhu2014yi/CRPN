...
parser.add_argument('--arch', dest='arch', default='CascadedSiamRPNRes22', help='architecture of model')
parser.add_argument('--resume', default='/ssd/zhuyi/Code/snapshot_orig/checkpoint_e28.pth', type=str, help='resumed model')
...
if __name__ == "__main__":
    ...
    ray.init(num_gpus=args.gpu_nums, num_cpus=args.gpu_nums *2, redirect_output=True, object_store_memory=20000000)
